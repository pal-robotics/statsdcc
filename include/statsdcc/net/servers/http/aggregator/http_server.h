...
#ifndef INCLUDE_STATSDCC_NET_SERVERS_HTTP_AGGREGATOR_HTTP_SERVER_H_
#define INCLUDE_STATSDCC_NET_SERVERS_HTTP_AGGREGATOR_HTTP_SERVER_H_
...
#endif  // INCLUDE_STATSDCC_NET_SERVERS_HTTP_AGGREGATOR_HTTP_SERVER_H_
